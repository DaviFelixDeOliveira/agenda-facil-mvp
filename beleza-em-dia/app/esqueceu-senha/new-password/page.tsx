...
export default function NewPasswordPage() {
  ...
  useEffect(() => {
    // Verificar se vem do fluxo de verificação
    ...
    <div className="min-h-screen flex items-center justify-center bg-[#FAFAFA] p-4 sm:p-8">
      <div className="w-full max-w-md sm:max-w-lg bg-white rounded-3xl p-6 sm:p-10 shadow-sm border border-gray-100 space-y-6">
        ...
        <div className="flex flex-col items-center text-center space-y-3">
          ...
          <div>
            <h1 className="text-2xl font-bold text-[#111827]">Crie uma Nova Senha</h1>
            <p className="text-sm text-gray-500 mt-1">Digite uma senha segura com pelo menos 6 caracteres</p>
          </div>
        </div>
