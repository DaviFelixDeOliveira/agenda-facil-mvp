    ...
    <div className="min-h-screen flex items-center justify-center bg-[#FAFAFA] p-4 sm:p-6">
      <div className="w-full max-w-md bg-white rounded-3xl p-6 sm:p-8 shadow-sm border border-gray-100 space-y-6">
        ...
        <div className="flex flex-col items-center text-center space-y-2">
          <div className="w-12 h-12 rounded-xl bg-[#111827] flex items-center justify-center mb-1">
            <span className="text-xl">⚡</span>
          </div>
          <h1 className="text-lg font-bold text-[#111827]">Termos de Uso e Política de Privacidade</h1>
          <p className="text-[11px] text-gray-400">Última atualização: 24 de Outubro de 2026</p>
        </div>

        {/* Texto rolável dos termos */}
        <div className="h-64 overflow-y-auto border border-gray-100 rounded-2xl p-4 bg-gray-50/50 space-y-4 text-xs text-gray-600 leading-relaxed scrollbar-thin">
          <div>
            <h2 className="font-bold text-[#111827] mb-1">1. Introdução</h2>
            <p>
          ...
          <div>
            <h2 className="font-bold text-[#111827] mb-1">2. Uso do Serviço</h2>
            <p>
          ...
          <div>
            <h2 className="font-bold text-[#111827] mb-1">3. Conformidade com a LGPD</h2>
            <p>
